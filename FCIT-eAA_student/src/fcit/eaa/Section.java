...
public class Section {
    ...
    public boolean slotContradicts(String slotTh, String slotL) {
        if (!slotForTheory.equalsIgnoreCase("TBA")) {
            if (!slotForTheory.equalsIgnoreCase("N/A") && !slotForLab.equalsIgnoreCase("N/A")) {
                if (slotForTheory.equalsIgnoreCase(slotTh) || slotForLab.equalsIgnoreCase(slotL)) {
                    return true;
                } else if (slotForTheory.contains(slotL) || slotTh.contains(slotForLab)) {
                    return true;
                }
            }
        }
